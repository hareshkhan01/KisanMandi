...
export const logIn = async (data: { email: string; password: string }) => {
  ...
  export const createAuction = async (data: { product: string;category:string; description: string;quality: string;unit:string;pickupLocation: string ;startingBid: number;minBidIncrement: number; quantity: number;duration: number }) => {
    try {
  ...
  export const updateAuction = async (id: string, data: { product: string;category:string; description: string;quality: string;unit:string;pickupLocation: string ;startingBid: number; quantity: number; duration: number}) => {
    try {
